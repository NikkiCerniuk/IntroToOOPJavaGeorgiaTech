...
public abstract class Player implements Comparable<Player> {
     ...
     */
    //YOUR CODE HERE
    //this code below is completed
    public abstract void emergencyMeeting(); //doesnt return anything. calls emergency meeting to vote on player to freeze
//Above function is complete
    /**
     ...
     */
    @Override //Override the compareTo method (You should be able to put @Override on the line before the method header)
    public int compareTo(Player p) {
            //if current player sus < player passed in then neg
            //if current player sus > player passed in then pos
            //if sus levels are equal then 0 
